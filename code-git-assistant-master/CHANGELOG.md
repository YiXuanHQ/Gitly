...
- 将以下文档中的版本号、VSIX 文件名与发布日期统一更新为 **1.0.2 / 2025-12-11**：
  - README.md / README_CN.md / PROJECT_OVERVIEW.md / PROJECT_DETAILS.md / QUICK_REFERENCE.md
  - docs/DEVELOPMENT.md / docs/QUICKSTART.md / docs/TESTING.md / docs/API.md
  - ROADMAP.md / GETTING_STARTED.md
- 补充 1.0.2 版本在 README/README_CN 中的更新日志条目
