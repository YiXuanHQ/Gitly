...
const translations: Record<SupportedLanguage, TranslationMap> = {
	'en': {
		...
		'sidebar.staged.none': 'No staged changes',
		'sidebar.staged.openFile': 'Open File',
	...
	'zh-CN': {
		'statusBar.text': 'Gitly 视图表 ',
		'statusBar.tooltip': '查看 Gitly 视图表 ',
		...
		'sidebar.history.openGraph': '打开 Git 视图表视图',
		'sidebar.staged.none': '当前没有已暂存的更改',
		'sidebar.staged.openFile': '打开文件',
