...
export interface RequestInitRepo extends BaseMessage {
	readonly command: 'initRepo';
	readonly path: string | null; // null => use current workspace folder
}
export interface ResponseInitRepo extends ResponseWithErrorInfo {
	readonly command: 'initRepo';
}

export interface RequestCloneRepo extends BaseMessage {
	readonly command: 'cloneRepo';
	readonly url: string;
	readonly path: string | null; // null => use current workspace folder
}
export interface ResponseCloneRepo extends ResponseWithErrorInfo {
	readonly command: 'cloneRepo';
}
