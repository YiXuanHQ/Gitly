...
export class DiffDocProvider extends Disposable implements vscode.TextDocumentContentProvider {
	 ...
	 * @param uri The `gitly://file.ext?encoded-data` URI.
...
/**
 * Represents the data passed through `gitly://file.ext?encoded-data` URI's by the DiffDocProvider.
 */
type DiffDocUriData = {
	filePath: string;
	commit: string;
 ...
 * @returns A URI of the form `gitly://file.ext?encoded-data` or `file://path/file.ext`
 */
...
/**
 * Decode the data from a `gitly://file.ext?encoded-data` URI.
