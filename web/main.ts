// I18n translations for web view
const webTranslations: { [lang: string]: { [key: string]: string } } = {
	'en': {
		'column.graph': 'Graph',
		...
		'find.of': 'of',
		'find.regexError': 'Cannot use a regular expression which has zero length matches',
		'settingsDialog.specifyRepoName': 'Specify a Name for this Repository:',
		'settingsDialog.name': 'Name',
		'settingsDialog.saveName': 'Save Name',
		'settingsDialog.deleteRepoNameConfirm': 'Are you sure you want to delete the manually configured name <b><i>%s1</i></b> for this repository, and use the default name from the File System <b><i>%s2</i></b>?',
		'settingsDialog.yesDelete': 'Yes, delete',
		'settingsDialog.configureInitialBranches': 'Configure Initial Branches',
		'settingsDialog.configureInitialBranchesDesc': 'Configure the branches that are initially shown when this repository is loaded in the Git Graph View.',
		'settingsDialog.configureInitialBranchesNote': 'Note: When "Checked Out Branch" is Disabled, and no "Specific Branches" are selected, all branches will be shown.',
		'settingsDialog.checkedOutBranch': 'Checked Out Branch',
		'settingsDialog.specificBranches': 'Specific Branches',
		'settingsDialog.saveConfiguration': 'Save Configuration',
		'settingsDialog.cancel': 'Cancel',
		'settingsDialog.clearInitialBranchesConfirm': 'Are you sure you want to clear the branches that are initially shown when this repository is loaded in the Git Graph View?',
		'settingsDialog.yesClear': 'Yes, clear',
		'settingsDialog.clearInitialBranches': 'Clear Initial Branches',
		'settingsDialog.setUserDetails': 'Set the user name and email used by Git to record the Author and Committer of commit objects:',
		'settingsDialog.userName': 'User Name',
		'settingsDialog.userEmail': 'User Email',
		'settingsDialog.useGlobally': 'Use Globally',
		'settingsDialog.useGloballyInfo': 'Use the "User Name" and "User Email" globally for all Git repositories (it can be overridden per repository).',
		'settingsDialog.setUserDetailsAction': 'Set User Details',
		'settingsDialog.removeUserDetailsConfirmGlobal': 'Are you sure you want to remove the <b>globally configured</b> user name and email, which are used by Git to record the Author and Committer of commit objects?',
		'settingsDialog.removeUserDetailsConfirmLocal': 'Are you sure you want to remove the <b>locally configured</b> user name and email, which are used by Git to record the Author and Committer of commit objects?',
		'settingsDialog.yesRemove': 'Yes, remove',
		'settingsDialog.addRemote': 'Add a new remote to this repository:',
		'settingsDialog.fetchUrl': 'Fetch URL',
		'settingsDialog.pushUrl': 'Push URL',
		'settingsDialog.pushUrlPlaceholder': 'Leave blank to use the Fetch URL',
		'settingsDialog.fetchImmediately': 'Fetch Immediately',
		'settingsDialog.addRemoteAction': 'Add Remote',
		'settingsDialog.editRemote': 'Edit the remote <b><i>%s1</i></b>:',
		'settingsDialog.saveChanges': 'Save Changes',
		'settingsDialog.deleteRemoteConfirm': 'Are you sure you want to delete the remote <b><i>%s1</i></b>?',
		'settingsDialog.fetchFromRemoteConfirm': 'Are you sure you want to fetch from the remote <b><i>%s1</i></b>?',
		'settingsDialog.prune': 'Prune',
		'settingsDialog.pruneInfo': 'Before fetching, remove any remote-tracking references that no longer exist on the remote.',
		'settingsDialog.pruneTags': 'Prune Tags',
		'settingsDialog.pruneTagsInfo': 'Before fetching, remove any local tags that no longer exist on the remote. Requires Git >= 2.17.0, and "Prune" to be enabled.',
		'settingsDialog.yesFetch': 'Yes, fetch',
		'settingsDialog.pruneRemoteConfirm': 'Are you sure you want to prune remote-tracking references that no longer exist on the remote <b><i>%s1</i></b>?',
		'settingsDialog.yesPrune': 'Yes, prune',
		'settingsDialog.editIssueLinking': 'Edit Issue Linking for this Repository',
		'settingsDialog.addIssueLinking': 'Add Issue Linking to this Repository',
		'settingsDialog.issueLinkingExample': 'The following example links <b>#123</b> in commit messages to <b>https://github.com/mhutchie/repo/issues/123</b>:',
		'settingsDialog.issueRegexInfo': 'A regular expression that matches your issue numbers, with one or more capturing groups ( ) that will be substituted into the "Issue URL".',
		'settingsDialog.issueUrlInfo': 'The issue\'s URL in your issue tracking system, with placeholders ($1, $2, etc.) for the groups captured ( ) in the "Issue Regex".',
		'settingsDialog.useGloballyIssue': 'Use Globally',
		'settingsDialog.useGloballyIssueInfo': 'Use the "Issue Regex" and "Issue URL" for all repositories by default (it can be overridden per repository). Note: "Use Globally" is only suitable if identical Issue Linking applies to the majority of your repositories (e.g. when using JIRA or Pivotal Tracker).',
		'settingsDialog.save': 'Save',
		'settingsDialog.prefilledIssueRegexDetected': 'The prefilled Issue Regex was detected in commit messages in this repository. Review and/or correct it if necessary.',
		'settingsDialog.invalidIssueRegex': 'Invalid Issue Regex',
		'settingsDialog.regexNoCapturingGroup': 'The regular expression does not contain a capturing group ( ).',
		'settingsDialog.invalidIssueUrl': 'Invalid Issue URL',
		'settingsDialog.issueUrlNoPlaceholders': 'The Issue URL does not contain any placeholders ($1, $2, etc.) for the issue number components captured in the Issue Regex.',
		'settingsDialog.goBack': 'Go Back',
		'settingsDialog.removeIssueLinkingConfirmLocal': 'Are you sure you want to remove the <b>locally configured</b> Issue Linking from this repository?',
		'settingsDialog.removeIssueLinkingConfirmGlobal': 'Are you sure you want to remove the <b>globally configured</b> Issue Linking in Git Graph?',
		'settingsDialog.removePullRequestIntegrationConfirm': 'Are you sure you want to remove the configured "Pull Request Creation" Integration?',
		'settingsDialog.exportRepoConfigConfirm': 'Exporting the Git Graph Repository Configuration will generate a file that can be committed in this repository. It allows others working in this repository to use the same configuration.',
		'settingsDialog.yesExport': 'Yes, export',
		'settingsDialog.configurePrIntegration': 'Configure "Pull Request Creation" Integration (Step&nbsp;1/2)',
		'settingsDialog.prProviderInfo': 'In addition to the built-in publicly hosted Pull Request providers, custom providers can be configured using the Extension Setting "gitly.customPullRequestProviders" (e.g. for use with privately hosted Pull Request providers).',
		'settingsDialog.sourceRemote': 'Source Remote',
		'settingsDialog.sourceRemoteInfo': 'The remote that corresponds to the source of the Pull Request.',
		'settingsDialog.destinationRemote': 'Destination Remote',
		'settingsDialog.destinationRemoteInfo': 'The remote that corresponds to the destination / target of the Pull Request.',
		'settingsDialog.next': 'Next',
		'settingsDialog.notARemote': 'Not a remote',
		'settingsDialog.configurePrIntegrationStep2': 'Configure "Pull Request Creation" Integration (Step&nbsp;2/2)',
		'settingsDialog.hostRootUrl': 'Host Root URL',
		'settingsDialog.hostRootUrlInfo': 'The Pull Request provider\'s Host Root URL (e.g. https://github.com).',
		'settingsDialog.sourceOwner': 'Source Owner',
		'settingsDialog.sourceOwnerInfo': 'The owner of the repository that is the source of the Pull Request.',
		'settingsDialog.sourceRepo': 'Source Repo',
		'settingsDialog.sourceRepoInfo': 'The name of the repository that is the source of the Pull Request.',
		'settingsDialog.destinationOwner': 'Destination Owner',
		'settingsDialog.destinationOwnerInfo': 'The owner of the repository that is the destination / target of the Pull Request.',
		'settingsDialog.destinationRepo': 'Destination Repo',
		'settingsDialog.destinationRepoInfo': 'The name of the repository that is the destination / target of the Pull Request.',
		'settingsDialog.destinationProjectId': 'Destination Project ID',
		'settingsDialog.destinationProjectIdInfo': 'The GitLab Project ID of the destination / target of the Pull Request. Leave this field blank to use the default destination / target configured in GitLab.',
		'settingsDialog.destinationBranch': 'Destination Branch',
		'settingsDialog.destinationBranchInfo': 'The name of the branch that is the destination / target of the Pull Request.',
		'settingsDialog.back': 'Back',
		'settingsDialog.clickToShow': 'Click to show',
		'settingsDialog.clickToHide': 'Click to hide',
		'settingsDialog.branchesOfRemote': ' branches of this remote.',
		'settingsDialog.unableToConfigurePrIntegration': 'Unable to configure the "Pull Request Creation" Integration',
		'settingsDialog.noRemotesForPrIntegration': 'The repository must have at least one remote to configure the "Pull Request Creation" Integration. There are no remotes in the current repository.',
		'settingsDialog.fetchUrlLabel': 'Fetch URL:',
		'settingsDialog.pushUrlLabel': 'Push URL:'
	},
	'zh-CN': {
		'column.graph': '图形',
		...
		'settings.section.gitGraphConfiguration': 'Gitly 视图表 配置',
		...
		'settings.gitGraph.openExtensionSettings': '打开 Gitly 视图表 扩展设置',
		...
		'context.commit.dropNote': '<br/><i>注意：启用“只跟踪提交的第一个父提交”后，Gitly 视图表 视图中可能隐藏了一些提交，这些提交可能会影响此操作的结果。</i>',
		...
		'find.previousMatch': '上一个匹配项 (Shift+Enter)',
		'find.nextMatch': '下一个匹配项 (Enter)',
		'find.openCommitDetails': '为当前匹配项打开提交详情视图',
		'find.close': '关闭 (Escape)',
		'find.noResults': '无结果',
		'find.of': '共',
		'find.regexError': '不能使用具有零长度匹配的正则表达式',
		'settingsDialog.specifyRepoName': '为此仓库指定名称：',
		'settingsDialog.name': '名称',
		'settingsDialog.saveName': '保存名称',
		'settingsDialog.deleteRepoNameConfirm': '确定要删除此仓库的手动配置名称 <b><i>%s1</i></b>，并使用文件系统中的默认名称 <b><i>%s2</i></b> 吗？',
		'settingsDialog.yesDelete': '是，删除',
		'settingsDialog.configureInitialBranches': '配置初始分支',
		'settingsDialog.configureInitialBranchesDesc': '配置在 Gitly 视图表中加载此仓库时最初显示的分支。',
		'settingsDialog.configureInitialBranchesNote': '注意：当"已检出分支"被禁用，且未选择"特定分支"时，将显示所有分支。',
		'settingsDialog.checkedOutBranch': '已检出分支',
		'settingsDialog.specificBranches': '特定分支',
		'settingsDialog.saveConfiguration': '保存配置',
		'settingsDialog.cancel': '取消',
		'settingsDialog.clearInitialBranchesConfirm': '确定要清除在 Gitly 视图表中加载此仓库时最初显示的分支吗？',
		'settingsDialog.yesClear': '是，清除',
		'settingsDialog.clearInitialBranches': '清除初始分支',
		'settingsDialog.setUserDetails': '设置 Git 用于记录提交对象的作者和提交者的用户名和邮箱：',
		'settingsDialog.userName': '用户名',
		'settingsDialog.userEmail': '用户邮箱',
		'settingsDialog.useGlobally': '全局使用',
		'settingsDialog.useGloballyInfo': '为所有 Git 仓库全局使用"用户名"和"用户邮箱"（可以按仓库覆盖）。',
		'settingsDialog.setUserDetailsAction': '设置用户信息',
		'settingsDialog.removeUserDetailsConfirmGlobal': '确定要删除<b>全局配置的</b>用户名和邮箱吗？这些信息用于让 Git 记录提交对象的作者和提交者。',
		'settingsDialog.removeUserDetailsConfirmLocal': '确定要删除<b>本地配置的</b>用户名和邮箱吗？这些信息用于让 Git 记录提交对象的作者和提交者。',
		'settingsDialog.yesRemove': '是，移除',
		'settingsDialog.addRemote': '向此仓库添加新远程：',
		'settingsDialog.fetchUrl': '获取 URL',
		'settingsDialog.pushUrl': '推送 URL',
		'settingsDialog.pushUrlPlaceholder': '留空以使用获取 URL',
		'settingsDialog.fetchImmediately': '立即获取',
		'settingsDialog.addRemoteAction': '添加远程',
		'settingsDialog.editRemote': '编辑远程 <b><i>%s1</i></b>：',
		'settingsDialog.saveChanges': '保存更改',
		'settingsDialog.deleteRemoteConfirm': '确定要删除远程 <b><i>%s1</i></b> 吗？',
		'settingsDialog.fetchFromRemoteConfirm': '确定要从远程 <b><i>%s1</i></b> 获取吗？',
		'settingsDialog.prune': '清理',
		'settingsDialog.pruneInfo': '在获取之前，删除远程上不再存在的任何远程跟踪引用。',
		'settingsDialog.pruneTags': '清理标签',
		'settingsDialog.pruneTagsInfo': '在获取之前，删除远程上不再存在的任何本地标签。需要 Git >= 2.17.0，并且需要启用"清理"。',
		'settingsDialog.yesFetch': '是，获取',
		'settingsDialog.pruneRemoteConfirm': '确定要清理远程 <b><i>%s1</i></b> 上不再存在的远程跟踪引用吗？',
		'settingsDialog.yesPrune': '是，清理',
		'settingsDialog.editIssueLinking': '编辑此仓库的问题链接',
		'settingsDialog.addIssueLinking': '向此仓库添加问题链接',
		'settingsDialog.issueLinkingExample': '以下示例将提交消息中的 <b>#123</b> 链接到 <b>https://github.com/mhutchie/repo/issues/123</b>：',
		'settingsDialog.issueRegexInfo': '匹配问题编号的正则表达式，包含一个或多个捕获组 ( )，这些组将被替换到"问题 URL"中。',
		'settingsDialog.issueUrlInfo': '问题跟踪系统中的问题 URL，包含占位符（$1、$2 等），用于"问题正则"中捕获的 ( ) 组。',
		'settingsDialog.useGloballyIssue': '全局使用',
		'settingsDialog.useGloballyIssueInfo': '默认情况下为所有仓库使用"问题正则"和"问题 URL"（可以按仓库覆盖）。注意：只有当相同的问题链接适用于大多数仓库时，"全局使用"才合适（例如，使用 JIRA 或 Pivotal Tracker 时）。',
		'settingsDialog.save': '保存',
		'settingsDialog.prefilledIssueRegexDetected': '在 this 仓库的提交消息中检测到预填充的问题正则。如有必要，请查看和/或更正。',
		'settingsDialog.invalidIssueRegex': '无效的问题正则',
		'settingsDialog.regexNoCapturingGroup': '正则表达式不包含捕获组 ( )。',
		'settingsDialog.invalidIssueUrl': '无效的问题 URL',
		'settingsDialog.issueUrlNoPlaceholders': '问题 URL 不包含任何占位符（$1、$2 等），用于问题正则中捕获的问题编号组件。',
		'settingsDialog.goBack': '返回',
		'settingsDialog.removeIssueLinkingConfirmLocal': '确定要删除此仓库的<b>本地配置的</b>问题链接吗？',
		'settingsDialog.removeIssueLinkingConfirmGlobal': '确定要删除 Gitly 视图表中的<b>全局配置的</b>问题链接吗？',
		'settingsDialog.removePullRequestIntegrationConfirm': '确定要删除配置的"拉取请求创建"集成吗？',
		'settingsDialog.exportRepoConfigConfirm': '导出 Gitly 视图表仓库配置将生成一个可以提交到此仓库的文件。它允许在此仓库中工作的其他人使用相同的配置。',
		'settingsDialog.yesExport': '是，导出',
		'settingsDialog.configurePrIntegration': '配置"拉取请求创建"集成（步骤&nbsp;1/2）',
		'settingsDialog.prProviderInfo': '除了内置的公开托管的拉取请求提供方之外，可以使用扩展设置 "gitly.customPullRequestProviders" 配置自定义提供方（例如，用于私有托管的拉取请求提供方）。',
		'settingsDialog.sourceRemote': '源远程',
		'settingsDialog.sourceRemoteInfo': '对应拉取请求源的远程。',
		'settingsDialog.destinationRemote': '目标远程',
		'settingsDialog.destinationRemoteInfo': '对应拉取请求的目标/目标的远程。',
		'settingsDialog.next': '下一步',
		'settingsDialog.notARemote': '不是远程',
		'settingsDialog.configurePrIntegrationStep2': '配置"拉取请求创建"集成（步骤&nbsp;2/2）',
		'settingsDialog.hostRootUrl': '主机根 URL',
		'settingsDialog.hostRootUrlInfo': '拉取请求提供方的主机根 URL（例如 https://github.com）。',
		'settingsDialog.sourceOwner': '源所有者',
		'settingsDialog.sourceOwnerInfo': '作为拉取请求源的仓库的所有者。',
		'settingsDialog.sourceRepo': '源仓库',
		'settingsDialog.sourceRepoInfo': '作为拉取请求源的仓库名称。',
		'settingsDialog.destinationOwner': '目标所有者',
		'settingsDialog.destinationOwnerInfo': '作为拉取请求的目标/目标的仓库的所有者。',
		'settingsDialog.destinationRepo': '目标仓库',
		'settingsDialog.destinationRepoInfo': '作为拉取请求的目标/目标的仓库名称。',
		'settingsDialog.destinationProjectId': '目标项目 ID',
		'settingsDialog.destinationProjectIdInfo': '拉取请求的目标/目标的 GitLab 项目 ID。将此字段留空以使用 GitLab 中配置的默认目标/目标。',
		'settingsDialog.destinationBranch': '目标分支',
		'settingsDialog.destinationBranchInfo': '作为拉取请求的目标/目标的分支名称。',
		'settingsDialog.back': '返回',
		'settingsDialog.clickToShow': '点击显示',
		'settingsDialog.clickToHide': '点击隐藏',
		'settingsDialog.branchesOfRemote': '此远程的分支。',
		'settingsDialog.unableToConfigurePrIntegration': '无法配置"拉取请求创建"集成',
		'settingsDialog.noRemotesForPrIntegration': '仓库必须至少有一个远程才能配置"拉取请求创建"集成。当前仓库中没有远程。',
		'settingsDialog.fetchUrlLabel': '获取 URL：',
		'settingsDialog.pushUrlLabel': '推送 URL：'
	}
};

function getWebT(language: string): { [key: string]: string } {
...
class GitGraphView {
	...
	public loadRepos(repos: GG.GitRepoSet, lastActiveRepo: string | null, loadViewTo: GG.LoadGitGraphViewTo) {
		...
		if (loadViewTo !== null) {
			if (loadViewTo.repo === newRepo) {
				...
				showErrorMessage(webT('error.unableToLoadRepo') + ' "' + loadViewTo.repo + '". It is not currently included in Git Graph.');
			}
		} else {
			this.loadViewTo = null;
		}
		...
		if (this.loadViewTo !== null && this.currentRepo === this.loadViewTo.repo) {
			if (this.loadViewTo.commitDetails && (this.expandedCommit === null || this.expandedCommit.commitHash !== this.loadViewTo.commitDetails.commitHash || this.expandedCommit.compareWithHash !== this.loadViewTo.commitDetails.compareWithHash)) {
				...
				if (commitElem !== null && (this.loadViewTo.commitDetails.compareWithHash === null || compareWithElem !== null)) {
					...
					showErrorMessage(webT('error.unableToResumeCodeReview') + ' ' + this.maxCommits + ' ' + webT('error.commitsLoaded'));
				}
	...
	public processLoadRepoInfoResponse(msg: GG.ResponseLoadRepoInfo) {
		if (msg.error === null) {
			...
			this.displayLoadDataError(webT('error.unableToLoadRepoInfo'), msg.error);
		}
	}
	...
	public processLoadCommitsResponse(msg: GG.ResponseLoadCommits) {
		if (msg.error === null) {
			...
			const error = this.gitBranches.length === 0 && msg.error.indexOf('bad revision \'HEAD\'') > -1
				...
				: msg.error;
			this.displayLoadDataError(webT('error.unableToLoadCommits'), error);
		}
	}
	...
	public getBranchOptions(includeShowAll?: boolean): ReadonlyArray<DialogSelectInputOption> {
		...
		if (includeShowAll) {
			options.push({ name: webT('dropdown.showAll'), value: SHOW_ALL_BRANCHES });
		}
	...
	private renderTable() {
		...
		let html = '<tr id="tableColHeaders"><th id="tableHeaderGraphCol" class="tableColHeader" data-col="0">' + webT('column.graph') + '</th><th class="tableColHeader" data-col="1">' + webT('column.description') + '</th>' +
			(colVisibility.date ? '<th class="tableColHeader dateCol" data-col="2">' + webT('column.date') + '</th>' : '') +
			(colVisibility.author ? '<th class="tableColHeader authorCol" data-col="3">' + webT('column.author') + '</th>' : '') +
			(colVisibility.commit ? '<th class="tableColHeader" data-col="4">' + webT('column.commit') + '</th>' : '') +
			'</tr>';
		...
		this.footerElem.innerHTML = this.moreCommitsAvailable ? '<div id="loadMoreCommitsBtn" class="roundedBtn">' + webT('button.loadMoreCommits') + '</div>' : '';
