...
class Config {
	...
	/**
	 * Get the value of the `gitly.contextMenuActionsVisibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.customBranchGlobPatterns` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.customEmojiShortcodeMappings` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.customPullRequestProviders` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.date.format` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.date.type` Extension Setting.
	 */
	get dateType() {
	...
	/**
	 * Get the value of the `gitly.defaultColumnVisibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.dialog.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `gitly.dialog.merge.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.dialog.pullBranch.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.enhancedAccessibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.fileEncoding` Extension Setting.
	 */
	get fileEncoding() {
	...
	/**
	 * Get the value of the `gitly.language` Extension Setting.
	 */
	get language() {
		// 语言设置定义在 `gitly` 配置节中，而不是 `git-graph`
		const langConfig = vscode.workspace.getConfiguration('gitly');
		return langConfig.get<string>('language', 'en');
	}
	...
	get graph(): GraphConfig {
		...
		return {
			colours: Array.isArray(colours) && colours.length > 0
				...
				: ['#3b82f6', '#ef4444', '#10b981', '#ec4899', '#a855f7', '#eab308', '#06b6d4', '#f97316', '#6366f1', '#14b8a6', '#f43f5e', '#fbbf24'],
	...
	/**
	 * Get the value of the `gitly.integratedTerminalShell` Extension Setting.
	 */
	...
	/**
	 * Get the keybinding configuration from the `gitly.keyboardShortcut.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `gitly.maxDepthOfRepoSearch` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.markdown` Extension Setting.
	 */
	get markdown() {
	...
	/**
	 * Get the value of the `gitly.openNewTabEditorGroup` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.openToTheRepoOfTheActiveTextEditorDocument` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.commits.fetchAvatars` Extension Setting.
	 */
	get fetchAvatars() {
	...
	/**
	 * Get the value of the `gitly.repository.commits.initialLoad` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.commits.loadMore` Extension Setting.
	 */
	get loadMoreCommits() {
	...
	/**
	 * Get the value of the `gitly.repository.commits.loadMoreAutomatically` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.commits.order` Extension Setting.
	 */
	get commitOrder() {
	...
	/**
	 * Get the value of the `gitly.repository.commits.showSignatureStatus` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.fetchAndPrune` Extension Setting.
	 */
	get fetchAndPrune() {
	...
	/**
	 * Get the value of the `gitly.repository.fetchAndPruneTags` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.includeCommitsMentionedByReflogs` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.onlyFollowFirstParent` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.showCommitsOnlyReferencedByTags` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.showRemoteBranches` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.showStashes` Extension Setting.
	 */
	get showStashes() {
	...
	/**
	 * Get the value of the `gitly.repository.showTags` Extension Setting.
	 */
	get showTags() {
	...
	/**
	 * Get the value of the `gitly.repository.showUncommittedChanges` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.showUntrackedFiles` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.repository.sign.commits` Extension Setting.
	 */
	get signCommits() {
	...
	/**
	 * Get the value of the `gitly.repository.sign.tags` Extension Setting.
	 */
	get signTags() {
	...
	/**
	 * Get the value of the `gitly.repository.useMailmap` Extension Setting.
	 */
	get useMailmap() {
	...
	/**
	 * Get the value of the `gitly.repositoryDropdownOrder` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.retainContextWhenHidden` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.showStatusBarItem` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `gitly.tabIconColourTheme` Extension Setting.
	 */
