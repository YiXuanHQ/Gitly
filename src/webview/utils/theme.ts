...
export const getThemeColors = () => {
    ...
    return {
        ...
        branchGraph: {
            node: light ? '#0066cc' : '#569cd6',
            nodeSelected: light ? '#0052a3' : '#4ec9b0',
            link: light ? '#0066cc' : '#569cd6',
            labelBg: light ? 'rgba(255, 255, 255, 0.95)' : 'rgba(0, 0, 0, 0.8)',
            labelText: light ? '#333333' : '#ffffff',
        },
    };
};
 ...
 * 获取 VS Code CSS 变量值
 */
export const getVSCodeColor = (variable: string, fallback: string = '#000000'): string => {
